...
def parse_args() -> None:
    ...
    program.add_argument('--execution-provider', help='available execution provider (choices: cuda, ...)', dest='execution_provider', default=['cuda'], choices=suggest_execution_providers(), nargs='+')
